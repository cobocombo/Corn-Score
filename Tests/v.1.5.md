...
| ----------- | ----------- | ----------- |
| App Tip on First Launch | On a fresh first launch an app tip should be shown giving the user an app tip. | PASS |
| Team 1 Increase / Decrease | When the user presses above the score label the score increases. When the user presses below the score label the score decreases. | PASS |
| Team 1 Increase / Decrease | When the user presses above the score label the score increases. When the user presses below the score label the score decreases. | PASS |
...
| Test Case      | Description | Decision |
| ----------- | ----------- | ----------- |
| Buy Me A Beer Link - Android | Pressing the buy me a beer button on the Android platform should open a custom tabs link. | PASS |
| Source Code Link - Android | Pressing the source code list item on the Android platform should open a custom tabs link. | PASS |
